...
GOOGLE_OAUTH_CLIENT_ID='google-client-id-canary' \
GOOGLE_OAUTH_CLIENT_SECRET='google-client-secret-canary' \
GOOGLE_AUTH_ATTEMPT_ENCRYPTION_KEY='BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=' \
